...
class Field
  extends React.PureComponent<FieldProps, FieldState>
  implements FieldEntity
{
  ...
  public getControlled = (childProps: ChildProps = {}) => {
    ...
    const value = name
      ? this.props.fieldContext.formStore.getFieldValue(name)
      : undefined;
    ...
    control[trigger] = (...args: any[]) => {
      ...
      fieldContext.formStore.udpateValue(name, newValue);
  ...
  public render() {
    ...
    if (React.isValidElement(children)) {
      returnChildNode = React.cloneElement(
        children,
        this.getControlled(children.props as ChildProps),
      );
    } else {
